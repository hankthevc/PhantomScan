        ...
        feed_data.append(
            {
                ...
                "breakdown": {
                    ...
                    "known_hallucination": float(row.get("known_hallucination", 0.0)),
                    "content_risk": float(row.get("content_risk", 0.0)),
                    ...
                    "docs_absence": float(row.get("docs_absence", 0.0)),
                    "provenance_risk": float(row.get("provenance_risk", 0.0)),
                    "repo_asymmetry": float(row.get("repo_asymmetry", 0.0)),
                    "download_anomaly": float(row.get("download_anomaly", 0.0)),
                    "version_flip": float(row.get("version_flip", 0.0)),
                },
